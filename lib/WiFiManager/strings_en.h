...
// const char HTTP_ROOT_MAIN[] PROGMEM = "<h1>SayaPatri</h1><h3>{v}</h3>";
const char *const HTTP_PORTAL_MENU[] PROGMEM = {
    ...
    "<form action='/exit'    method='get'><button>Exit</button></form><br/>",                       // MENU_EXIT
    "<hr/><br/>"                                                                                    // MENU_SEP
};
...
const char S_brand[] PROGMEM = "Sayapatri";
